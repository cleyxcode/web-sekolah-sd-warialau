            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="isi" rows="14"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent resize-y @error('isi') border-red-400 bg-red-50 @enderror">{{ old('isi') }}</textarea>
